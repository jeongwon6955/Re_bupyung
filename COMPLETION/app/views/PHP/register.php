...
<body>
    <div class="login-box">
        ...
        <form method="POST" action="/Re_bupyung/COMPLETION/public/register"> 
        ...
        ?>
        <button type='button'><p style="margin-top: 15px;"><a href="/Re_bupyung/COMPLETION/public/login">로그인으로 돌아가기</a></p></button>
    </div>
</body>
</html>